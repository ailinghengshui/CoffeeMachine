...
public class DialogTitleInputNumber extends BaseDialog implements View.OnClickListener {
    ...
    public static DialogTitleInputNumber newInstance(String title, String desc, String hint) {
        DialogTitleInputNumber dialogTitle=new DialogTitleInputNumber();
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        etInput.setFilters(new InputFilter[]{new InputFilter.LengthFilter(MAX_LENGTH)});
