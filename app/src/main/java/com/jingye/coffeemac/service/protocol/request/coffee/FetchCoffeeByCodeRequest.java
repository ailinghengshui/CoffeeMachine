...
public class FetchCoffeeByCodeRequest extends Request {

	private String fetchCode;
	
	private long timestamp;
	
	public FetchCoffeeByCodeRequest(String uid, String fetchCode, long timestamp) {
		super(uid);
	...
	public short getCommandId() {
		return ICoffeeService.CommandId.FETCH_COFFEE_BY_CODE;
	}
