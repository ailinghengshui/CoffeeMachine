...
public class ResetStockRequest extends Request {

    private int userID;

    private String inventory;

	public ResetStockRequest(String uid, int userID, String inventory) {
		super(uid);
        this.userID = userID;
	...
	public short getCommandId() {
		return ICoffeeService.CommandId.RESET_STOCK;
	}
