...
public interface IAuthService {
	...
	public interface CommandId {
		...
		public static final short CID_LOGOUT = 5; // 登出

		public static final short CID_LOGIN_NEW = 30; // 新登录
	}

	public interface KickoutReason {
		public static final short PwdWrong = 1;      // 密码错了
		public static final short UserNotExist = 2;  // 咖啡机不存在
		public static final short MacAddressError = 3; // mac地址错误
