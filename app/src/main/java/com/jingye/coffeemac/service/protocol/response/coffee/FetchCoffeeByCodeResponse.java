...
@ResponseID(service = ServiceID.SVID_LITE_COFFEE, command = { ICoffeeService.CommandId.FETCH_COFFEE_BY_CODE
		+ "" })
public class FetchCoffeeByCodeResponse extends SingleResponse {
